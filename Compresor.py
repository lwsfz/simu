...
def biseccion(func, a, b, tol=1e-6, max_iter=100000):
    if func(a)[0] * func(b)[0] > 0:
        raise ValueError("La función debe cambiar de signo en el intervalo [a, b].")
    
    elif func(a)[0] * func(b)[0] == 0:
        if func(a)[0] == 0:
            diferencia_c, T_3_c, C_3_for_c, h_3s_c, rho_3_c = func(a)
        else:
            diferencia_c, T_3_c, C_3_for_c, h_3s_c, rho_3_c = func(a)
    else:
    ...
    try:
        ...
        for etapa in range(1, num_etapas + 1):
            ...
            try:
                ...
                print('El flujo másico es:', mass_flow)
                ...
                W_u1= U - C_u1
                print(W_u1, 'Este es W_u1', Ca_1, 'este ca1')
                W_1 = math.sqrt(W_u1**2 + Ca_1**2)
                print(W_1,'W_1')
                beta_1_rad = math.atan(W_u1/Ca_1) #Angulo relativo del flujo a la entrada del álabe
                i=beta_1_rad - beta_1_prima #negativo en 13684
                print('i = ',i)
                i_grad = i*180/pi
                print(i_grad, 'i en grados')
                beta_1 = beta_1_rad*180/pi
                print(beta_1, 'este es beta 1')
                ...
                def funcion(Ca_2):
                            ...
                            print(Ca_2,C_2,C_u2, C_u1,'c_2 y C_u1')
                            ...
                            #print(rho_2,rho_1,'densidades salida entrada')
                            m_dot_for_2 = rho_2* Ca_2* np.pi*2*rm*H_2 #* C_2 * math.cos(alpha_2) * 2 * np.pi * rm * H_2
                            print(alpha_2, math.cos(alpha_2), 'alpha2')
                            diferencia_2 = m_dot_for_2 - mass_flow
                            print(m_dot_for_2, mass_flow, 'flujo másico')
                ...
                print(C_u2,'c_u',Ca_2,'C_A', alpha_2,'alpha')
########################################################################
