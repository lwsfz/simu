...
"""
Modulo que simula el comportamiento de la camara de combustion
"""
import pyromat as pm
import math

#Configuracion de las unidades
...
def secant_method(func, x0, x1, tol=1e-6, max_iter=10000):
    """
...
def cam_comb(variables, resultados_comp, T_out):
    try:
        ...
        def calculate_n(n): #Funcion utilizada para el calculo del exceso de aire (n)
            ...
            dif, c_out, P_out = secant_method(get_c_out, 100, 300)
            
            '''
            resultados de interes del difusor:
                c_out : Velocidad de salida de la camara de combustión/ de entrada a la tubrina [m/s]
                T_out : Temperatura de salida del difusor / de entrada al compresor [K]
                P_out : Presion de salida del difusor / de entrada al compresor [Pa]
                m_dot : Fujo masico calculado para el motor
                n1 : exceso de aire en la combustion
                m_cble : Flujo masico de combustible
                composicion_cc : Comoposicion del flujo a la salida de la camara de combustion
            '''
        ...
        print("Error", "Ingresa valores validos en todos los campos")
