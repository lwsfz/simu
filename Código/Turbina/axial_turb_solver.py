...
from Turbina.loss_model import *
...
class solver_object:
    ...
    def problem_solver(self, T_in: float, p_in: float, n_rpm: float, C_inx=None, m_dot=float,
        ...
        def inner_solver(var_C_inx=None, solverdec_lastcall=False):
            ...
            if not self.cfg.chain_mode and solverdec_lastcall:
                ...
                ps_list += [[DELTA_h, w_total, P_total, h_0A, h_0B, s_A, s_B, p_B, p_0B, T_0B, T_0Bss, h_0Bss, Y_maq, w_ss_total,
...
def main():
    ...
    if chain_mode:
        ...
        solver.problem_solver(T_in=3000, p_in=170000, n_rpm=17000, p_out = 100000, C_inx_ref=130)
        #solver.problem_solver(T_in=resultados['T_inlet'], p_in=resultados['P_out'], n_rpm=resultados['rpm'], m_dot=resultados['mass_flow'], C_inx_ref=130)
