...
def cam_comb(variables, resultados_comp, T_out):
    ...
    se quiere calcular el flujo de combustible a través de la expresión del balance de energia,
    para poder conocer el valor de n,
    para ello sera necesario asumir que la combustión es completa y que 
    el calor transferido es 0.
    Una vez hechas estas suposiciones necesitamos calcular la masa del combustible y 
    los productos a través de un balance de reacciones
    De este balance tenemos la relación del combustible con los productos, que se 
    ...
    def calculate_n(n): #Función utilizada para el cálculo del exceso de aire (n)
        ...
        "Propiedades termodinámicas necesarias para obtener c y P"
